...
get_ipython().system('apt-get install python-opengl -y  >/dev/null')
get_ipython().system('apt install xvfb -y >/dev/null')


# In[3]:


get_ipython().system('pip install pyvirtualdisplay >/dev/null')
get_ipython().system('pip install piglet >/dev/null')
...
get_ipython().run_line_magic('time', 'hist3 = train_model(env, model, total_episodes=3500)')
...
get_ipython().run_line_magic('time', 'hist4 = train_model(env, model, total_episodes=1500)')
